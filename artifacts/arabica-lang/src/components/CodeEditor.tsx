...
const KEYWORDS = ['كنز', 'سرّ', 'سر', 'مهمّة', 'مهمة', 'بنية', 'إن', 'ان', 'وإلا', 'والا', 'كرر', 'جوال', 'من', 'إلى', 'الى', 'في', 'بخطوة', 'أعد', 'اعد', 'قف', 'استمر', 'طابق', 'حال', 'انتهى'];
const BUILTINS = ['أرني', 'ارني', 'شبكة_عصبية', 'درّب', 'تنبأ', 'خسارة', 'دقة', 'جذر', 'مطلق', 'قوة', 'دور', 'سقف', 'أرضية', 'عشوائي', 'عشوائي_صحيح', 'أقصى', 'أدنى', 'مجموع', 'متوسط', 'طول', 'نوع', 'رقم', 'نص', 'قائمة', 'إضافة', 'حذف', 'أول', 'آخر', 'فرز', 'عكس', 'دمج', 'شريحة', 'انضم', 'نطاق', 'مصفوفة', 'مفاتيح', 'قيم', 'تقسيم', 'استبدال', 'تقليم', 'يحتوي', 'يبدأ_بـ', 'ينتهي_بـ', 'حروف_كبيرة', 'حروف_صغيرة', 'تكرار', 'خريطة', 'تصفية', 'اختزال', 'وقت', 'مسح', 'تطبيع', 'دالة_سيغمويد', 'دالة_ريلو'];
