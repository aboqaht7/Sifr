...
// قيمة = متغير،  سرّ = ثابت،  مهمّة = دالة،  أرني = أظهر مخرجات
          ...
          <div className="repl-pane">
            ...
            <div className="repl-input-row">
              ...
              <input
                ...
                onKeyDown={onReplKey}
                placeholder="مثال:  قيمة س = 5    أو    س * 2"
                dir="rtl"
              />
  ...
  return (
    <div className="docs-panel">
      ...
      <section>
        ...
        <code>{`قيمة عمر: رقم = 25\nقيمة اسم: نص = "محمد"\nقيمة ق: قائمة = [1، 2]`}</code>
      ...
      <section>
        ...
        <p style={{ fontSize: '0.85em', opacity: 0.85, lineHeight: 1.7 }}>
          <strong>تعريف مكوّن:</strong> <code>{'قيمة بطاقتي = مكوّن(مهمّة(خ){ … أعد عنصر })'}</code><br/>
          <strong>الحالة:</strong> <code>{'قيمة [عدد، عيّن_عدد] = حالة(0)'}</code> — أعد العرض تلقائياً عند التغيير<br/>
